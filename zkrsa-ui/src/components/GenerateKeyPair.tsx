...
export const GenerateKeyPair: FunctionComponent<GenerateKeyPair> = ({ setkeyPair, setjsonPublicKey }) => {
    return (
        <>
            <div className="my-5 ml-10">
                <button onClick={async () => {
                    ...
                    setkeyPair(keypair);
                    const jsonPubKey = await window.crypto.subtle.exportKey("jwk", keypair.publicKey);
